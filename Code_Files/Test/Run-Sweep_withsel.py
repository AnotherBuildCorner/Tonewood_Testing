...
def record_audio(filename, duration, sampling_rate, device_index, event):
    chunk = 1024
    ...
    # Open stream using specified device index
...
if __name__ == "__main__":
    ...
    record_process = multiprocessing.Process(target=record_audio, args=(output_filename, duration, sampling_rate, device_index, event))
